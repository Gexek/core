...
(function() {
	...
	tinymce.create('tinymce.plugins.JMFormPlugin', {
		init : function(ed, url) {
			...
			// Register buttons
			each([
				['jmform', 'jmform.gif', 'درج/ویرایش فرم', 'mceJMFormInsertForm', true],
  			['jmform_delete', 'jmform_delete.gif', 'حذف فرم انتخاب شده', 'mceJMFormDelete'],
  			['jmform_insert_input', 'jmform_insert_input.gif', 'درج/ویرایش ورودی', 'mceJMFormInsertInput', true],
  			['jmform_insert_select', 'jmform_insert_select.gif', 'درج/ویرایش لیست کشویی', 'mceJMFormInsertSelect', true],
  			['jmform_insert_textarea', 'jmform_insert_textarea.gif', 'درج/ویرایش ورودی متن', 'mceJMFormInsertTextarea', true]
			], function(c) {
